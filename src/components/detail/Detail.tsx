                    ...
                    <div className="flex items-start gap-x-8 ">
                        ...
                        <div>
                                ...
                                <div className="flex items-center gap-x-3">
                                    {data?.followers.some(
                                        ...
                                        <button
                                            ...
                                            className="hover:opacity-60 block text-sm text-neutral-700 font-semibold py-[10px] px-5 rounded-lg bg-[#7ebeff]">
                                            {isLoading
                                                ? "Loading..."
                                                : " Unfollow"}
                                        </button>
                                        ...
                                        <button
                                            ...
                                            className="hover:opacity-60 block text-sm text-white font-semibold py-[10px] px-5  rounded-lg bg-[#877EFF]">
                                            {isLoading
                                                ? "Loading..."
                                                : " Follow"}
                                        </button>
                                    )}
                                    <button className="flex items-center text-sm font-semibold text-black rounded-lg bg-[#EFEFEF] py-[10px] px-5">
                                        Message
                                    </button>
                                </div>
                            </div>
                            ...
                            <p className="text-[#EFEFEF] mb-10">
                                ...
                                JavaScript Mastery <br /> ✉️ Business Inquiries
                                - Email or DM
                            </p>
